...
class RecurrentTodoSlidable extends ConsumerWidget {
  ...
  const RecurrentTodoSlidable({super.key, required this.index, required this.id, required this.name});
    ...
    return Slidable(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: ref.watch(todoProvider.notifier).isComplete(id) ? Colors.green[300] : Colors.amber[300],
          borderRadius: const BorderRadius.all(
            Radius.circular(20),
          ),
        ),
